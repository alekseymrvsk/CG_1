...
MainWindow = Tk()
MainWindow.title("Мироевский Алексей, 3 курс, 12 группа, Вариант 8, RGB <--> XYZ <--> HSV")
...
labAuthor = Label(text="Мироевский Алексей, 3 курс, 12 группа",
                  font=("Times New Roman", "24"),
                  bg="#FFFFFF")
labAuthor.pack()
